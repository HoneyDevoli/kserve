# KServe HF server поверх стабильного vLLM 0.23. Канонический тег :v0.23.0 собран на CUDA 13.0
# (torch cu130) — суффикса -cu130 нет, т.к. это дефолт (альт-вариант — :v0.23.0-cu129).
# Только sm_75+ (A100 и новее) — vLLM 0.20+ выпилил Volta/sm_70, на V100 не запускается.
# Параллельный образ к :v0.20.0.
